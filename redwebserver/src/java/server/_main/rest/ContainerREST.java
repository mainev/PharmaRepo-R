...
import server._main.facade.ContainerFacade;
...
public class ContainerREST {
    ...
    /**
     * Creates a new instance of ContainerREST
     */
    public ContainerREST() {
    }

    /**
     * Retrieves representation of an instance of server._main.rest.ContainerREST
     * @return an instance of java.lang.String
     */
    @GET
    @Produces("application/json")
    public List<Container> getJson() {
